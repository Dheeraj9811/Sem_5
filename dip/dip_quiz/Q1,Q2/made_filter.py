...
def zoom(img , direction):
    filter = np.array([[1,1,0],[1,1,0],[1,1,0]],ndmin=3)
    m,n = img.shape
...
# gaussian_filter = (np.array([[1,2,1],[2,4,2],[1,2,1]],ndmin=3))/16
# used to blur edges and reduced contrast and similar to median filter but faster
#Assuming 2X super-resolution
# k = [1 1 0]
# What will be the kernel for 3X super-resolution?
# k = [0 1 1 1 0]
